...
function Show-SystemInfo {
    ...
    # RAM: total + type + speed on one line, then one line per physical
    # stick - "Slot N: ..." for a real removable module, "Onboard N: ..."
    # when the SMBIOS form factor says it's soldered. Prefers the accurate
    # raw-SMBIOS parse; falls back to Win32_PhysicalMemory (can't tell
    # "Row of chips" apart from a normal module, so everything reads as
    # "Slot N" there) only if the raw table couldn't be read at all.
